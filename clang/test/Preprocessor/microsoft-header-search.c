// RUN: %clang_cc1 -Wno-header-shadowing -I%S/Inputs/microsoft-header-search %s -fms-compatibility -verify
...
// expected-warning@Inputs/microsoft-header-search/a/b/include3.h:5 {{#include resolved using non-portable Microsoft search rules as}}
