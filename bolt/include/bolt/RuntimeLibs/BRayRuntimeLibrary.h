...
#ifndef BOLT_RUNTIMELIBS_BRAY_RUNTIME_LIBRARY_H
#define BOLT_RUNTIMELIBS_BRAY_RUNTIME_LIBRARY_H
...
class BRayRuntimeLibrary : public RuntimeLibrary {
public:
  ...
  static constexpr StringLiteral EntryDispatchName =
      "__bolt_bray_entry_dispatch";
  static constexpr StringLiteral ExitDispatchName = "__bolt_bray_exit_dispatch";
  static constexpr StringLiteral EntryDispatchOffsetName =
      "__bolt_bray_entry_dispatch_offset";
  static constexpr StringLiteral ExitDispatchOffsetName =
      "__bolt_bray_exit_dispatch_offset";
